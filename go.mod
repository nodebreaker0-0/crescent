...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/nodebreaker0-0/cosmos-sdk v0.45.7-ics-crescent-v3
	github.com/cosmos/ibc-go/v3 => github.com/nodebreaker0-0/ibc-go/v3 v3.0.0-crescent-v3
